...
intellijPlatform {
    pluginConfiguration {
        ...
        changeNotes = """
            Also send to the active AI Assistant (ACP), GitHub Copilot Chat, Android Studio Gemini, or unique Swing text input, and added the clip icon to
...
tasks {
    runIde {
        systemProperty("code.reference.inserter.debug", "true")
    }
